class Octopus {
  constructor(headSize, bodySize) {
    this.color = [0, 0, 1, 1];
    // this.matrix = new Matrix4(rootMatrix);

    //Create Body
    this.body = new Cube();
    this.body.color = this.color;
    // this.body.matrix = new Matrix4(rootMatrix);
    ...
    this.head.matrix.rotate(-90, 1, 0, 0);
    // this.head.matrix.rotate(-90, 0, 1, 0);
  ...
  render(rootMatrix) {
    const matrix = new Matrix4(rootMatrix);
    matrix.translate(0, -0.5, 0);

    // Render the head
    this.head.matrix = new Matrix4(rootMatrix);
    this.head.render();
    ...
    this.body.matrix = new Matrix4(rootMatrix);
    this.body.matrix.translate(0,-0.5,0);
